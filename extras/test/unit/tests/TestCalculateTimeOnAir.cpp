...
static std::vector<RadioConfig> allConfigs = {
    { "SX126x", RADIOLIB_MODEM_LORA,  {.lora={7,RADIOLIB_UNIT_KILO(125),5}}, {.lora={8,false,true,true}}, {1,10,50,255}, {30976,46336,128256,548096} }, // 30.97, 46.33, 128.25, 548.09
    { "SX126x", RADIOLIB_MODEM_LORA,  {.lora={11,RADIOLIB_UNIT_KILO(250),8}}, {.lora={16,true,false,false}}, {5,15,100,200}, {296960,362496,1411072,2590720} }, // 296.96, 362.49, 1410, 2590
    { "SX126x", RADIOLIB_MODEM_FSK,   {.fsk={RADIOLIB_UNIT_KILO(100),RADIOLIB_UNIT_KILO(10)}},   {.fsk={16,16,2}}, {1,16,64,200}, {560,1760,5600,16480} },
    ...
    { "SX127x", RADIOLIB_MODEM_LORA, {.lora={6,RADIOLIB_UNIT_KILO(125),6}}, {.lora={8,false,true,false}}, {7,23,98,156}, {23000,39000,115000,174000} }, // 20.61, 39.04, 115.84, 174.21 
    { "SX127x", RADIOLIB_MODEM_LORA, {.lora={8,RADIOLIB_UNIT_KILO(250),8}}, {.lora={32,true,true,false}}, {10,20,80,160}, {70000,87000,210000,373000} }, // 69.89, 86.27, 209.15, 372.99
    { "SX127x", RADIOLIB_MODEM_LORA, {.lora={12,RADIOLIB_UNIT_KILO(125),7}}, {.lora={8,false,true,true}}, {1,24,64,128}, {893000,1811000,3646000,6628000} }, // 892.93, 1810.43, 3645.50, 6627.59
    ...
    { "LR11x0", RADIOLIB_MODEM_LORA, {.lora={10,RADIOLIB_UNIT_KILO(250),5}}, {.lora={8,false,true,true}}, {1,20,100}, {103424,205824,615424} }, // 103.42, 205.82, 615.42
    { "LR11x0", RADIOLIB_MODEM_LORA, {.lora={11,RADIOLIB_UNIT_KILO(500),6}}, {.lora={32,true,false,false}}, {10,25,200}, {205824,279552,1065984} }, // 205.82, 279.55, 1070
    { "LR11x0", RADIOLIB_MODEM_FSK,  {.fsk={RADIOLIB_UNIT_KILO(200),RADIOLIB_UNIT_KILO(50)}},   {.fsk={16,32,2}}, {1,32,64,200}, {360,1600,2880,8320} },
