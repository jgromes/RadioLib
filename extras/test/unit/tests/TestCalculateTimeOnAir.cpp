...
static std::vector<RadioConfig> allConfigs = {
    ...
    { "SX127x", RADIOLIB_MODEM_LORA, {.lora={6,RADIOLIB_UNIT_KILO(125),6}}, {.lora={8,false,true,false}}, {7,23,98,156}, {20608,39040,115840,174208} }, // 20.61, 39.04, 115.84, 174.21 
    { "SX127x", RADIOLIB_MODEM_LORA, {.lora={8,RADIOLIB_UNIT_KILO(250),8}}, {.lora={32,true,true,false}}, {10,20,80,160}, {69888,86272,209152,372992} }, // 69.89, 86.27, 209.15, 372.99
