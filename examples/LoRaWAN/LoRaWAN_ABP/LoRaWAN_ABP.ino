...
void setup() {
  ...
  ConfigLoRa_t config;
  config.frequency = RADIOLIB_UNIT_MEGA(868); // The frequency here does not matter, as it will get changed by LoRaWAN anyway
  //radio.tcxoVoltage = RadioLibTCXOVoltage_t::Voltage1V6; // Some radio modules like SX126x often come with TCXO
