...
*/
#define RADIOLIB_ERR_SSDV_JPEG_TRUNCATED                        (-1509)

/*!
  \brief The two encoding passes yielded a different packet count.
*/
#define RADIOLIB_ERR_SSDV_INTERNAL_MISMATCH                     (-1510)
