...
const LoRaWANBand_t EU868 = {
  ...
  .dataRates = {
    ...
    { .modem = RADIOLIB_MODEM_LRFHSS, .dr = {.lrFhss = {2, 3, 1}},  .pc = {.lrFhss = {1}}},
    { .modem = RADIOLIB_MODEM_LRFHSS, .dr = {.lrFhss = {2, 1, 1}},  .pc = {.lrFhss = {1}}},
    { .modem = RADIOLIB_MODEM_LRFHSS, .dr = {.lrFhss = {4, 3, 1}},  .pc = {.lrFhss = {1}}},
    { .modem = RADIOLIB_MODEM_LRFHSS, .dr = {.lrFhss = {4, 1, 1}},  .pc = {.lrFhss = {1}}},
...
const LoRaWANBand_t US915 = {
  ...
  .dataRates = {
    ...
    { .modem = RADIOLIB_MODEM_LRFHSS, .dr = {.lrFhss = {8, 3, 0}},  .pc = {.lrFhss = {1}}},
    { .modem = RADIOLIB_MODEM_LRFHSS, .dr = {.lrFhss = {8, 1, 0}},  .pc = {.lrFhss = {1}}},
    RADIOLIB_DATARATE_NONE,
