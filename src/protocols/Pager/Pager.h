  ...
  public:
    ...
    */
    ...
    /*!
      ...
      \param base Base (center) RF frequency to be used in Hz.
    ...
    */
    int16_t begin(uint32_t base, uint16_t speed, bool invert = false, uint16_t shift = RADIOLIB_PAGER_FREQ_SHIFT_HZ);
