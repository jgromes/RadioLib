...
int16_t SX1268::begin(const SX126x::ConfigLoRa_t& config) {
...
int16_t SX1268::beginFSK(const SX126x::ConfigFSK_t& config) {
  // execute common part
...
int16_t SX1268::beginBPSK(const SX126x::ConfigBPSK_t& config) {
  // execute common part
...
int16_t SX1268::beginLRFHSS(const SX126x::ConfigLRFHSS_t& config) {
  // execute common part
