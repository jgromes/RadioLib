...
int16_t SX1268::begin(const ConfigLoRa_t& config) {
...
int16_t SX1268::beginFSK(const ConfigFSK_t& config) {
  // execute common part
...
int16_t SX1268::beginBPSK(const ConfigBPSK_t& config) {
  // execute common part
...
int16_t SX1268::beginLRFHSS(const ConfigLRFHSS_t& config) {
  // execute common part
