...
int16_t SX1268::beginLRFHSS(float freq, uint8_t bw, uint8_t cr, int8_t power, float tcxoVoltage, bool useRegulatorLDO) {
  // execute common part
  int16_t state = SX126x::beginLRFHSS(bw, cr, tcxoVoltage, useRegulatorLDO);
  RADIOLIB_ASSERT(state);
