...
int16_t LR1110::begin(const LR11x0::ConfigLoRa_t& cfg) {
  // execute common part
...
int16_t LR1110::beginGFSK(const LR11x0::ConfigGFSK_t& cfg) {
  // execute common part
...
int16_t LR1110::beginLRFHSS(const LR11x0::ConfigLRFHSS_t& cfg) {
  // execute common part
